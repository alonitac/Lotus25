...
### :pencil2: Manual deployment of your microservice to AWS EC2

Before starting, make should that you already have built docker images of you frontend and backend images, stored in DockerHub. 

1. Create a free-tier eligible EC2 instance as explained above.
2. Connect to the instance via SSH.
3. Install docker.
4. Get you source code from your GitHub repository (by `git clone`).
5. Launch your microservice stack (by `docker compose up`).

Visit the public IP address of your EC2 instance in your browser to see your microservice in action!
